...
![Shoebox, vertical]({{ site.url }}{{ site.baseurl }}/assets/images/tk1-sketch.png)
![Shoebox, horizontal]({{ site.url }}{{ site.baseurl }}/assets/images/tk1-concept1.jpg)
![L shape, small]({{ site.url }}{{ site.baseurl }}/assets/images/tk1-concept2.jpg)
